...
<Canvas>
  <Story name="Localized fr" height="360px">
    <DateInput label="fr-FR" currentLocale="fr" locale={fr} m={2} />
  </Story>
</Canvas>

<Canvas>
  <Story name="Localized es" height="360px">
    <DateInput label="es-ES" currentLocale="es" locale={es} m={2} />
  </Story>
</Canvas>

<Canvas>
  <Story name="Localized ru" height="360px">
    <DateInput label="ru-RU" currentLocale="ru" locale={ru} m={2} />
  </Story>
</Canvas>

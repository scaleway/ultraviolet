...
<Meta title="Components/Data Display/Table" component={Table} />
...
<Description>
  ...
  `data-visibility=&quot;hover&quot;` on the component to make it only visible
  on hover.
</Description>

...
describe('TextBox', () => {
  test('should render correctly', () => {
    shouldMatchEmotionSnapshot(<TextBox />)
  })
  ...
  test('should render correctly label and noTopLabel', () => {
    shouldMatchEmotionSnapshot(<TextBox label="Test" value="test" noTopLabel />)
    shouldMatchEmotionSnapshot(<TextBox value="test" noTopLabel />)
    shouldMatchEmotionSnapshot(<TextBox label="Test" value="test" />)
  })
  ...
  test('should render random', () => {
    shouldMatchEmotionSnapshot(<TextBox random="test" name="test" />)
    shouldMatchEmotionSnapshot(

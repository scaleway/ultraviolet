...
import { ActivityIndicator, Box, Button } from "../.."
    ...
    <Box mx={8} my={2}>
      <ControlValue value>
        {({ value, onChange }) => (
          <>
            <Button
              onClick={() => onChange({ value: 'pulse', label: 'pulse' })}
              mb={4}
            >
            ...
            >
              {Object.keys(animations).map(animation => (
                <RichSelect.Option value={animation}>
                  {animation}
                </RichSelect.Option>
              ))}
            </RichSelect>
      ...
      return (
        <Box>
          ...
          <RichSelect
            isLoading={isLoading}
            components={{
              LoadingIndicator: () => <ActivityIndicator size={24} />,
            }}
          >
            <RichSelect.Option value="a">Option A</RichSelect.Option>
            <RichSelect.Option value="b">Option B</RichSelect.Option>

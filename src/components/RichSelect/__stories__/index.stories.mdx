...
<Meta title="Components/Data Entry/RichSelect" component={RichSelect} />
...
Use `noTopLabel` to hide the label.
...
Use `isSearchable` prop to make option searchable.
...
Use `required` to make this input mandatory
...
Use `disabled` to disable this input

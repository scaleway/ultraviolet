    ...
    {() => {
      ...
      return (
        <>
          ...
          <Modal animated animation="scaleUp" opened={opened} onClose={() => setOpened(false)}>
            <Box p={4}>Content should be present in center of the modal</Box>
            <Box p={4}>Content should be present in center of the modal</Box>
            <Box p={4}>Content should be present in center of the modal</Box>
            <Box p={4}>Content should be present in center of the modal</Box>
    ...
    {() => {
      ...
      return (
        <>
          ...
          <Modal animated animation="slide" opened={opened} onClose={() => setOpened(false)}>
    ...
    {() => {
      ...
      return (
        <>
          ...
          <Modal animated animation="zoom" opened={opened} onClose={() => setOpened(false)}>
            <Box p={4}>Modal should be animated</Box>
          </Modal>
        </>
      )
    ...
    {() => {
      ...
      return (
        <>
          ...
          <Modal animated animation="scaleBack" opened={opened} onClose={() => setOpened(false)}>
            <Box p={4}>Modal should be animated</Box>
          </Modal>
        </>
      )
    ...
    {() => {
      ...
      return (
        <>
          ...
          <Modal animated animation="sketch" opened={opened} onClose={() => setOpened(false)}>
            <Box p={4}>Modal should be animated</Box>
          </Modal>
        </>
      )
    ...
    {() => {
      ...
      return (
        <>
          ...
          <Modal animated animation="slide" opened={opened} onClose={() => setOpened(false)}>
            <Box p={4}>Modal should be animated with slide animation</Box>
          </Modal>
        </>
      )
    }}

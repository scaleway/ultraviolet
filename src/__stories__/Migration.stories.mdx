...
## I want to migrate my component with new name

1. Step one, the old component should be marked as deprecated in story.

  For stories, you can simply use the parameter `deprecated` into your story default export. It should look as follows:

  ```typescript
    export default {
      component: Button,
      parameters: { deprecated: true }, // <= Right here
      title: 'Components/Button/Button',
    } as Meta
  ```

  This will add a badge and a message into your storybook documentation. It should look as follows:
  <img src="https://scaleway-ui-storybook-images.s3.fr-par.scw.cloud/Screenshot%202022-05-17%20at%2016.23.10.png" alt="deprecated example screenshot" />

2. Second step is to mark component deprecated trough JSDoc comments with a beautiful description on what to replace usage by. It should look as follows:

...
Here is an exemple of custom theme you can use to extend and replace colors from Scaleway UI's [default theme](https://github.com/scaleway/scaleway-ui/blob/master/src/theme/index.js)

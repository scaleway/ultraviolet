...
Here is an exemple of custom theme you can use to extend and replace colors from Scaleway UI's [default theme](https://github.com/scaleway/scaleway-ui/blob/main/src/theme/index.ts)

...
- <b>⚠ WARNING:</b> If the `min` or `max` prop is set in addition with `step`
  prop you need to be coherent in the number you are setting up. If the `step`
  is a multiple of 5 then you need to set your `min` or `max` to be also a
  multiple of 5.

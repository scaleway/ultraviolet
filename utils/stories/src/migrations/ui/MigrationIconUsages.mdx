...
<br />
Currently we import all the icons contained in the library but depending on your
usage you may not need all of them. This issue is particularly important for the
web application where the bundle size is a critical point.

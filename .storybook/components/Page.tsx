...
import type { PageExtraProps } from './DocsContainer'
...
const A11yDocumentation = ({ a11yContent }: Pick<PageExtraProps, 'a11yContent'>) => {
  if (!a11yContent) {
    return null
  }
...
export const Page = ({
  ...
  console.debug('Page', { a11yContent, ...props })
  return (
    <div className={storiesTheme}>
      <Stack gap={1}>
        ...
        <Stack gap={2}>
          ...
          {a11yContent ? <A11yDocumentation a11yContent={a11yContent} /> : null}
        </Stack>
      </Stack>
    </div>
  )

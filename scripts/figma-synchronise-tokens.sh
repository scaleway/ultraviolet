...
do
   ...
   declare -a matchingArray=( ["productLight"]="light" ["productDark"]="dark" ["productDarker"]="darker" )
 ...
 */
export const ${matchingArray[globals[$count]]}Theme = "; echo "${FINAL_RESULT}") > packages/themes/src/themes/console/"${matchingArray[globals[$count]]}".ts

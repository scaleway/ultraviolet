...
<Playground>
  <Boxer my={1}>
    <UncontrolledTextBox label="First Name" defaultValue="Tabulation is ok here" />
    <UncontrolledTextBox label="No name" tabIndex="-1" defaultValue="No tabulation in this field" />
    <UncontrolledTextBox label="Last Name" defaultValue="Tabulation is ok here" />
  </Boxer>
</Playground>

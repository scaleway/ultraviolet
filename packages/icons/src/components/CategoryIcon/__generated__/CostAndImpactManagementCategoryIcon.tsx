...
export const CostAndImpactManagementCategoryIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="CostAndImpactManagementCategoryIcon">
    <g fillRule="evenodd" className="sentiment=primary, disabled=false" clipRule="evenodd">
      <path
        fill="#521094"

...
/**
 * @deprecated This component will be removed in next major. Please use direct imports from `@ultraviolet/icons` instead.
 * For example: `import { Address, AddressOutline } from '@ultraviolet/icons.
 * Props are same as before (except for `name` that is now explicit and not needed) only the import changes.
 *

...
export const SupportIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="SupportIcon">
    {typeof props.size === 'string' && ['medium', 'large', 'xlarge', 'xxlarge'].includes(props.size) ? (
      ...
      <path
        fillRule="evenodd"
        d="M12.95 3.05a7 7 0 1 0-9.9 9.9 7 7 0 0 0 9.9-9.9m-7.262-.042a5.52 5.52 0 0 1 4.624 0L8.698 5.082a3 3 0 0 0-1.396 0zm-2.68 2.68a5.52 5.52 0 0 0 0 4.624l2.074-1.614a3 3 0 0 1 0-1.396zm2.68 7.304 1.614-2.074c.458.11.938.11 1.396 0l1.614 2.074a5.52 5.52 0 0 1-4.624 0m7.304-2.68a5.52 5.52 0 0 0 0-4.624l-2.074 1.614c.11.458.11.938 0 1.396zM6.94 6.939a1.5 1.5 0 1 1 2.122 2.122A1.5 1.5 0 0 1 6.94 6.939"
        clipRule="evenodd"
      />
    )}
  </Icon>

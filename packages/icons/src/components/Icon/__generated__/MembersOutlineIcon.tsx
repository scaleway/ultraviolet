...
export const MembersOutlineIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="MembersOutlineIcon">
    {typeof props.size === 'string' && ['medium', 'large', 'xlarge', 'xxlarge'].includes(props.size) ? (
      ...
      <path
        fillRule="evenodd"
        d="M8 2.907a1.391 1.391 0 1 0 0 2.782 1.391 1.391 0 0 0 0-2.782m-2.558 1.39a2.558 2.558 0 1 1 5.115 0 2.558 2.558 0 0 1-5.115 0M3.557 5.376a.897.897 0 1 0 0 1.795.897.897 0 0 0 0-1.795m-2.064.897a2.064 2.064 0 1 1 4.128 0 2.064 2.064 0 0 1-4.128 0m10.949-.897a.897.897 0 1 0 0 1.794.897.897 0 0 0 0-1.794m-2.064.897a2.064 2.064 0 1 1 4.128 0 2.064 2.064 0 0 1-4.128 0M8 8.83a3.36 3.36 0 0 0-3.366 3.348v.017l.001.08A7.3 7.3 0 0 0 8 13.093a7.3 7.3 0 0 0 3.364-.818l.001-.08v-.017A3.36 3.36 0 0 0 8 8.83m4.49 3.948a.58.58 0 0 1-.275.361A8.44 8.44 0 0 1 8 14.26a8.44 8.44 0 0 1-4.215-1.12.58.58 0 0 1-.275-.36 6.5 6.5 0 0 1-2.114-.368.58.58 0 0 1-.388-.504 2.558 2.558 0 0 1 3.487-2.585A4.52 4.52 0 0 1 8 7.662c1.412 0 2.674.647 3.504 1.659a2.558 2.558 0 0 1 3.488 2.585.58.58 0 0 1-.388.504 6.5 6.5 0 0 1-2.115.367m-.353-2.434c.178.396.3.822.357 1.268a5.3 5.3 0 0 0 1.314-.176 1.39 1.39 0 0 0-1.67-1.092m-8.275 0a1.396 1.396 0 0 0-1.67 1.092q.631.167 1.313.176c.057-.446.18-.872.357-1.268"
        clipRule="evenodd"
      />
    )}
  </Icon>

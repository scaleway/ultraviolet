...
export const GmailLogo = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="GmailLogo">
    <g clipPath="url(#a)">
      ...
      <path fill="#FBBC04" d="M14.364 5.09v4.728L18 7.091V5.636c0-1.349-1.54-2.118-2.618-1.309" />
      <path fill="#EA4335" d="M5.636 9.818V5.091L10 8.364l4.364-3.273v4.727L10 13.091" />
      <path fill="#C5221F" d="M2 5.636v1.455l3.636 2.727V5.091l-1.018-.764C3.538 3.518 2 4.287 2 5.637" />
    </g>
    <defs>
      <clipPath id="a">

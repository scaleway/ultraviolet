  ...
  <Icon {...props}>
    <g className="Folder" clipPath="url(#a)">
      ...
      <g className="Icon">
        ...
        <path
          fill="#F1EEFC"
          d="M17 48h26a5 5 0 0 0 5-5V28a5 5 0 0 0-5-5H31.936a1.515 1.515 0 0 1-1.355-.838l-.158-.316C29.499 19.998 28.065 18 26 18h-9a5 5 0 0 0-5 5v20a5 5 0 0 0 5 5"
          className="fillWeak"
        />
        <path
          fill="#521094"
          d="M17 19a4 4 0 0 0-4 4v20a4 4 0 0 0 4 4h26a4 4 0 0 0 4-4V28a4 4 0 0 0-4-4H31.936a2.515 2.515 0 0 1-2.25-1.39l-.158-.317c-.44-.88-.972-1.734-1.595-2.355C27.317 19.323 26.681 19 26 19zm-6 4a6 6 0 0 1 6-6h9c1.384 0 2.498.676 3.346 1.522.841.84 1.488 1.91 1.971 2.876l.159.317a.515.515 0 0 0 .46.285H43a6 6 0 0 1 6 6v15a6 6 0 0 1-6 6H17a6 6 0 0 1-6-6z"
          className="fill"
          clipRule="evenodd"
          fillRule="evenodd"
        />

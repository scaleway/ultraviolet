...
export const Zone = ({ ...props }: Omit<IconProps, 'children'>) => (
  ...
  <Icon {...props}>
    <g className="Zone" clipPath="url(#b)">
      ...
      <path
        fill="#4F0599"
        d="M31.98 12.799A1 1 0 0 0 31 12c-11.598 0-21 9.402-21 21s9.402 21 21 21a1 1 0 0 0 1-1V13c0-.069-.007-.136-.02-.201M30 14.123c-2.668.659-5.07 3.91-6.53 8.588a38.712 38.712 0 0 1 6.53-.7zm0 9.89c-2.54.064-4.943.372-7.116.871C22.32 27.34 22 30.09 22 33c0 2.91.32 5.66.884 8.116 2.173.499 4.575.807 7.116.871zm0 19.975a38.712 38.712 0 0 1-6.53-.7c1.46 4.68 3.862 7.93 6.53 8.589zm-4.595 7.175a19.044 19.044 0 0 1-12.568-12.568c1.986 1.786 4.904 3.229 8.395 4.173.944 3.49 2.387 6.409 4.173 8.395M12 33c0 3.06 3.455 5.89 8.711 7.53A39.143 39.143 0 0 1 20 33c0-2.648.25-5.189.711-7.53C15.455 27.11 12 29.94 12 33m.837-5.595c1.986-1.786 4.904-3.229 8.395-4.173.944-3.49 2.387-6.409 4.173-8.395a19.044 19.044 0 0 0-12.568 12.568"
        className="fill"
        clipRule="evenodd"
        fillRule="evenodd"
      />

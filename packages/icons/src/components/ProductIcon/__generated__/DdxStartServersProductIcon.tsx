...
export const DdxStartServersProductIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="DdxStartServersProductIcon">
...
DdxStartServersProductIcon.displayName = 'DdxStartServersProductIcon'

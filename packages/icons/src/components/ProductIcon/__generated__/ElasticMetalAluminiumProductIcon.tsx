...
export const ElasticMetalAluminiumProductIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="ElasticMetalAluminiumProductIcon">
    <g>
      <g clipPath="url(#a)">
        <g>
          <path
...
ElasticMetalAluminiumProductIcon.displayName = 'ElasticMetalAluminiumProductIcon'

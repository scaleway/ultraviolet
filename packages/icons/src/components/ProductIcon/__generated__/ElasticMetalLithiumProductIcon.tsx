...
export const ElasticMetalLithiumProductIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="ElasticMetalLithiumProductIcon">
...
ElasticMetalLithiumProductIcon.displayName = 'ElasticMetalLithiumProductIcon'

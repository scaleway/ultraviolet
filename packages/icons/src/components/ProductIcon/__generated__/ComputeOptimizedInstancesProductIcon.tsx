...
export const ComputeOptimizedInstancesProductIcon = (props: Omit<IconProps, 'children'>) => (
  <Icon {...props}>
    <g clipPath="url(#clip0_791_2095)">
      ...
      <path
        ...
        d="M22.1 31.87q0-1.03.46-1.84.47-.82 1.27-1.27a3.6 3.6 0 0 1 1.81-.46q1.17 0 2.05.6t1.23 1.66h-1.61a1.67 1.67 0 0 0-.68-.75 1.95 1.95 0 0 0-1-.25q-.61 0-1.09.29-.47.28-.74.8-.26.52-.26 1.22 0 .69.26 1.22.27.52.74.81.48.28 1.09.28.57 0 1-.25.44-.26.68-.76h1.61q-.35 1.07-1.23 1.67-.87.59-2.05.59-1 0-1.81-.45a3.4 3.4 0 0 1-1.27-1.27q-.46-.81-.46-1.84m13.106-1.32q0 .56-.27 1.05-.26.49-.83.79-.56.3-1.42.3h-1.17v2.68h-1.4v-6.98h2.57q.81 0 1.38.28t.85.77q.29.49.29 1.11m-2.58 1.01q.58 0 .86-.26.28-.27.28-.75 0-1.02-1.14-1.02h-1.11v2.03zm4.954-3.17v4.32q0 .71.37 1.09.37.37 1.04.37.68 0 1.05-.37.37-.38.37-1.09v-4.32h1.41v4.31q0 .89-.39 1.51a2.4 2.4 0 0 1-1.03.92q-.64.31-1.43.31-.78 0-1.42-.31a2.37 2.37 0 0 1-1-.92q-.37-.62-.37-1.51v-4.31z"
      />
    </g>
  </Icon>
)

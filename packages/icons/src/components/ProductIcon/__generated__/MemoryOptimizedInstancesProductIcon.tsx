...
export const MemoryOptimizedInstancesProductIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="MemoryOptimizedInstancesProductIcon">
    <g clipPath="url(#clip0_791_2096)">
      ...
      <path
        ...
        d="M29.055 28.41v6.98h-1.334v-4.54l-1.783 4.54h-1.01l-1.793-4.54v4.54h-1.334v-6.98h1.516l2.116 5.19 2.116-5.19zm2.368 1.13v1.75h2.241v1.11h-2.241v1.85h2.527v1.14h-3.861V28.4h3.861v1.14zm10.708-1.13v6.98h-1.335v-4.54l-1.782 4.54h-1.011l-1.792-4.54v4.54h-1.335v-6.98h1.516l2.116 5.19 2.117-5.19z"
      />
    </g>
  </Icon>
)

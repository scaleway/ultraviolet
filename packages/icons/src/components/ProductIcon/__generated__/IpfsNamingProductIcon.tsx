...
export const IpfsNamingProductIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
      ...
      <g>
        ...
        <g fill="#521094" className="fill">
          ...
          <path
            ...
            fillRule="evenodd"
          />
          <path d="m24.828 9.467-2.344 8.914h-1.48l2.343-8.914zm4.138 4.097v1.37h-3.367v-1.37zm4.717 0v1.37h-3.367v-1.37zm4.717 0v1.37h-3.367v-1.37zm4.592-4.097-2.344 8.914h-1.48l2.343-8.914z" />
        </g>
      </g>
    </g>
  </Icon>
...
IpfsNamingProductIcon.displayName = 'IpfsNamingProductIcon'

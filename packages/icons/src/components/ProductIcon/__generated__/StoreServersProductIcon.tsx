...
export const StoreServersProductIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="StoreServersProductIcon">
...
StoreServersProductIcon.displayName = 'StoreServersProductIcon'

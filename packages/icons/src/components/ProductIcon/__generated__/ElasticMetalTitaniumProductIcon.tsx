...
export const ElasticMetalTitaniumProductIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="ElasticMetalTitaniumProductIcon">
    <g className="Elasticmetal-Titanium">
      <g className="Elasticmetal-Titanium-icon" clipPath="url(#a)">
        <g className=".Square">
          <path
            fill="#f1eefc"
        ...
        <g className="Elasticmetal">
          ...
          <path
            fill="#a060f6"
            d="M46.144 27.032v1.356h-2.232v7.02h-1.68v-7.02H40v-1.356zm2.078.936q-.444 0-.744-.276a.96.96 0 0 1-.288-.708q0-.42.288-.696.3-.288.744-.288c.444 0 .54.096.732.288q.3.276.3.696t-.3.708a1 1 0 0 1-.732.276m.828.792v6.648h-1.68V28.76z"
            className="fillStrong"
          />
        </g>
      </g>
...
ElasticMetalTitaniumProductIcon.displayName = 'ElasticMetalTitaniumProductIcon'

...
export const PasskeyProductIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="PasskeyProductIcon">
    <g className="sentiment=original, size=xlarge, disabled=false">
      ...
      <g fill="#fff" fillRule="evenodd" className="fill" clipRule="evenodd">
        <path d="M32 31a5.895 5.895 0 1 0 0-11.79A5.895 5.895 0 0 0 32 31Zm0 2a7.895 7.895 0 1 0 0-15.79A7.895 7.895 0 0 0 32 33Zm-3 4.158a6 6 0 0 0-6 6v5.631a1 1 0 1 1-2 0v-5.631a8 8 0 0 1 8-8h10.5a1 1 0 1 1 0 2H29Z" />
        <path d="M32 11c-11.046 0-20 8.954-20 20s8.954 20 20 20l-1 1v1c-11.5-.5-21-9.85-21-22S19.85 9 32 9s22 9.85 22 22c0 2.345-.367 4.605-1.048 6.727l-1.904-.61A20 20 0 0 0 52 31c0-11.046-8.954-20-20-20Z" />
      </g>
      <path
        fill="#bf95f9"
        fillRule="evenodd"
...
PasskeyProductIcon.displayName = 'PasskeyProductIcon'

...
export const InstanceEnterpriseProductIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="InstanceEnterpriseProductIcon">
    <g className="Instance-Enterprise">
      ...
      <path
        fill="#A365F6"
        d="M24.446 30.142v1.752h2.428v1.112h-2.428v1.852h2.737V36H23v-7h4.183v1.142zM34.664 36h-1.446l-3.274-4.797V36h-1.446v-7h1.446l3.274 4.807V29h1.446zM41 29.01v1.132h-1.921V36h-1.446v-5.858H35.71V29.01z"

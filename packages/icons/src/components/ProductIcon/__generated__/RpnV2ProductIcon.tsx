...
export const RpnV2ProductIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="RpnV2ProductIcon">
    <g className="RPN-V2">
      <g className=".Square">
        <path
          fill="#F1EEFC"

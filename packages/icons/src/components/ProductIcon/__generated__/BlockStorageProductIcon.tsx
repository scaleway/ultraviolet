...
export const BlockStorageProductIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="BlockStorageProductIcon">
    <g className="Block-Storage">
      <g className="Block-Storage-icon">
        ...
        <path
          fill="#a365f6"
          d="M24.513 31.598a.99.99 0 0 0-.513.873v8.073a1 1 0 0 0 .524.879l7.083 3.837a.99.99 0 0 0 .965-.007l7.071-3.83a1 1 0 0 0 .524-.88v-7.918q0-.05-.005-.1a.99.99 0 0 0-.505-.97l-7.083-3.984a1 1 0 0 0-.985.003zm8.57 11.103v-5.417l5.083-2.929v5.593zm4.061-10.265-5.059-2.845-5.063 2.88 5.058 2.877zm-6.061 4.755L26 34.215v5.733l5.083 2.753z"

...
export const RpnV1ProductIcon = ({ ...props }: Omit<IconProps, 'children' | 'title'>) => (
  <Icon {...props} title="RpnV1ProductIcon">
    <g className="RPN-V1">
      <g className=".Square">
        <path
          fill="#F1EEFC"
...
RpnV1ProductIcon.displayName = 'RpnV1ProductIcon'

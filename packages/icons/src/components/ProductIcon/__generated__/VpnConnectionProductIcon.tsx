    ...
    <g className="sentiment=original, size=xlarge, disabled=false">
      ...
      <g className="Icon">
        ...
        <g fill="#fff" className="fill">
          <path d="M32 33.143c.577 0 1.052.423 1.117.967l.008.128v2.19c0 .605-.504 1.096-1.125 1.096a1.115 1.115 0 0 1-1.117-.968l-.008-.127v-2.19c0-.606.504-1.096 1.125-1.096Z" />
          <path
            fillRule="evenodd"

...
export const Containers = ({ ...props }: Omit<IconProps, 'children'>) => (
  ...
  <Icon {...props}>
    <g className="Serverless-Containers">
      ...
      <path
        fill="#4F0599"
        d="M31.969 7a1 1 0 0 1 .993.883l.007.117-.001 7.532.06.012a5.002 5.002 0 0 1 3.936 4.67l.005.217a5 5 0 0 1-10 0 1 1 0 1 1 2 0 3 3 0 1 0 3-3 1 1 0 0 1-.994-.883l-.006-.117V8a1 1 0 0 1 1-1"
        className="fill"
      />
      <path
        fill="#A365F6"

...
export const ElasticMetalLithiumProductIcon = ({
  ...props
}: Omit<IconProps, 'children'>) => (
  // eslint-disable-next-line react/jsx-props-no-spreading
  <Icon {...props}>
    <g className="Elasticmetal-Lithium">
      <g className="Elasticmetal-Lithium-icon" clipPath="url(#a)">
        <g className=".Square">
          <path
            fill="#F1EEFC"
        ...
        <g className="Elasticmetal">
          ...
          <path
            fill="#A060F6"
            d="M43.68 34.076h2.76v1.332H42v-8.376h1.68zm4.68-6.108q-.444 0-.744-.276a.96.96 0 0 1-.288-.708q0-.42.288-.696.3-.288.744-.288c.444 0 .54.096.732.288q.3.276.3.696t-.3.708a1 1 0 0 1-.732.276m.828.792v6.648h-1.68V28.76z"
            className="fillStrong"
          />
        </g>
      </g>

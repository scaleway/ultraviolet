...
describe('Slider', () => {
  ...
  test('renders correctly with value < min>', () => {
    ...
    expect(asFragment()).toMatchSnapshot()
    expect(screen.getByRole<HTMLInputElement>('slider').value).toBe('10')
  })
  ...
  test('renders correctly custom tooltip', () => {
    const { asFragment } = renderWithTheme(
      <Slider value={1} name="Name" label="Label" labelTooltip="tooltip" />,
    )
    expect(asFragment()).toMatchSnapshot()
  })
  ...
  test('renders correctly default tooltip', () => {
    const { asFragment } = renderWithTheme(
      <Slider value={1} name="Name" label="Label" labelTooltip />,
    )
    expect(asFragment()).toMatchSnapshot()
  })
  ...
  test('renders correctly with ticks', () => {
    const { asFragment } = renderWithTheme(

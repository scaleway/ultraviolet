...
describe('double slider', () => {
  ...
  it('renders correctly direction row double', () => {
    shouldMatchSnapshot(
      <Slider direction="row" double label="Label" labelDescription="labeldescription" name="Name" value={[1, 14]} />,
    )
  })
  ...
  it('renders correctly with value empty array with min max', () => {
    shouldMatchSnapshot(<Slider double label="Label" max={10} min={0} name="Name" value={[]} />)
  })

  it('renders correctly direction row double with input', () => {
    shouldMatchSnapshot(<Slider direction="row" double input label="Label" name="Name" value={[1, 14]} />)
  })

  it('renders correctly double ', () => {
    shouldMatchSnapshot(<Slider double label="Label" name="Name" value={[12, 14]} />)
  })
  ...
  it('renders correctly double disabled', () => {
    shouldMatchSnapshot(<Slider disabled double label="Label" name="Name" value={[12, 14]} />)
  })

  it('renders correctly double input', () => {
    shouldMatchSnapshot(<Slider double input label="Label" name="Name" value={[12, 14]} />)
  })

  it('renders correctly double custom tooltip', () => {
    shouldMatchSnapshot(<Slider double label="Label" name="Name" tooltip={['tooltip', 'tooltip2']} value={[12, 14]} />)
  })

  it('renders correctly double default toolip ', () => {
    shouldMatchSnapshot(<Slider double label="Label" name="Name" tooltip value={[12, 14]} />)
  })

  it('renders correctly custom value ', () => {
    shouldMatchSnapshot(
      <Slider customValueDisplay="customValue" double label="Label" name="Name" tooltip value={[12, 14]} />,
    )
  })
  ...
  it('renders correctly custom value with input ', () => {
    const { asFragment } = renderWithTheme(
      <Slider customValueDisplay="customValue" double input label="Label" name="Name" tooltip value={[12, 14]} />,
    )
  ...
  it('renders correctly double with custom ticks', () => {
    shouldMatchSnapshot(<Slider double label="Label" name="Name" options={options} value={[0, 3]} />)
  })

  it('renders correctly double with custom ticks and defaultScale', () => {
    shouldMatchSnapshot(<Slider defaultScale double label="Label" name="Name" options={options} value={[0, 3]} />)
  })
  ...
  it('renders correctly double step', () => {
    shouldMatchSnapshot(<Slider double label="Label" name="Name" step={0.5} value={[12, 14]} />)
  })
  ...
  it('handles correctly onChange double', async () => {
    ...
    const { asFragment } = renderWithTheme(
      <Slider data-testid="slider" double input name="slider" onChange={onChange} value={[1, 2]} />,
    )
  ...
  it('handles correctly onChange with min and max double', async () => {
    ...
    const { asFragment } = renderWithTheme(
      <Slider data-testid="slider" double input max={10} min={2} name="slider" onChange={onChange} value={[3, 5]} />,
    )
    const sliderRight = screen.getByTestId<HTMLInputElement>('slider-right')
    const sliderLeft = screen.getByTestId<HTMLInputElement>('slider-left')

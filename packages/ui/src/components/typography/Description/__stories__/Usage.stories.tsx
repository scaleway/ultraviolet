...
export const Usage: StoryFn<typeof Description> = () => (
  <Stack gap={3}>
    ...
    <Stack direction="row" gap={2} justifyContent="center" alignItems="end">
      <SelectInput label="Input1" name="input11" options={values} size="medium" helper="Helper" />
      <SelectInput label="Input2" name="input12" options={values} size="medium" helper="Helper" />
    ...
    <Stack direction="column" gap={0.5} justifyContent="center">
      <Row gap={2} templateColumns="1fr 1fr 1fr" alignItems="end">
        <SelectInput name="input21" options={values} size="medium" label="Input1" aria-describedby="id1" />
        <SelectInput name="input22" options={values} size="medium" label="Input2" aria-describedby="id2" />
        <Checkbox>Checkbox</Checkbox>
      </Row>

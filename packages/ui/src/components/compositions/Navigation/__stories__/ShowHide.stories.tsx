...
const showContent = (
  <>
    See all products
    <ArrowDownIcon />
    <Badge prominence="strong" sentiment="primary" size="small">
      New
    </Badge>
  </>
)
      ...
      >
        ...
        >
          <Navigation.Item
            ...
            alwaysVisible
            categoryIcon={
              <OrganizationDashboardCategoryIcon variant="neutral" />
            }
          ...
          <Navigation.ShowHide
            ...
            tooltip={showHide === 'hide' ? 'Click to show' : 'Hide content'}
          />
          <Navigation.Separator />
          <Navigation.Item
            alwaysVisible

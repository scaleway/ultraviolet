...
describe('avatar', () => {
  describe.each(['circle', 'square'] as const)('renders correctly with shape %s', shape => {
      ...
      size => {
        ...
        it('renders correctly with variant text and upload', async () => {
          ...
          const { asFragment } = renderWithTheme(
            <Avatar data-testid="avatar" onClick={onClick} shape={shape} size={size} text="UV" upload variant="text" />,
          )

...
export const ContainerId: StoryFn<typeof ToastContainer> = args => (
  <Stack direction="row" gap={2}>
    ...
    <Button onClick={() => toast.success('Toaster from container 1', undefined, 'toaster1')} sentiment="neutral">
      Container 1
    </Button>
    <ToastContainer {...args} containerId="toaster2" position="top-right" />
    <Button onClick={() => toast.success('Toaster from container 2', undefined, 'toaster2')} sentiment="neutral">
      Container 2
    </Button>
  </Stack>
)

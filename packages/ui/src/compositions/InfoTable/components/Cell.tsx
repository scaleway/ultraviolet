...
export const InfoTableCell = ({ children, title, multiline = false, style }: CellProps) => (
  <Stack className={infoTableStyle.cell} gap="0.5" minWidth="0" style={style} width="100%">
    <Text as="dt" className={infoTableStyle.term} prominence="weak" sentiment="neutral" variant="bodySmallStrong">
      {title}
    </Text>
    <Text
      as="dd"

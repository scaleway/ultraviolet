...
describe('estimateCost - index', () => {
  ...
  it('render with isBeta, discount 0.5 and defaultTimeUnit months', () => {
    const { asFragment } = renderWithTheme(
  ...
  it('render with discount 0.5 and defaultTimeUnit months', () => {
    const { asFragment } = renderWithTheme(
  ...
  it('render with commitmentFees and iscommitmentFeesCreditCard', () => {
    const { asFragment } = renderWithTheme(
      <EstimateCost commitmentFees={10} hideTotal>
        <EstimateCost.Item label="Test" monthlyPrice={99}>
          <EstimateCost.Strong>Test</EstimateCost.Strong>
  ...
  it('render with description as node', () => {
    const { asFragment } = renderWithTheme(

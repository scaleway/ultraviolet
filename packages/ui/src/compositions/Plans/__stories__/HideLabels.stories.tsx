...
const planStarter = {
  data: {
    ...
    pipeline: <ContentPlan description="€4.00 per additional" title="1 pipeline" />,
...
const planProfessional = {
  data: {
    ...
    pipeline: <ContentPlan description="€4.00 per additional" title="10 pipelines" />,
    ssl: <ContentPlan title="SSL Certificate" />,
  },
  header: {
    cta: (
...
const planAdvanced = {
  data: {
    ...
    gb: <ContentPlan description="Here the icon is centered" iconAlign="center" title="10 TB" />,
    pipeline: <ContentPlan description="€4.00 per additional" iconAlign="center" title="100 pipelines" />,

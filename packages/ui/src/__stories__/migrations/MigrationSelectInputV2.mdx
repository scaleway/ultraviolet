...
* `description` (ReactNode): more information on the option. The description can be placed at the right or beneath the option label in the dropdown with the prop `direction`, which is **global**. *This prop is optional*.

...
const illustrationKeys = Object.keys(ILLUSTRATIONS).filter(key => !key.startsWith('__') && key !== 'displayName')
    ...
    <Stack alignItems="center" direction="row" gap={1} key={name}>
      <Stack alignItems="flex-start" direction="column">
        <Stack alignItems="center" direction="row" gap={1}>
          <WireIllustration {...args} name={name as ComponentProps<typeof WireIllustration>['name']} />
        </Stack>
      </Stack>

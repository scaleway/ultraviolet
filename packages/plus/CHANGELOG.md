...
- [#6289](https://github.com/scaleway/ultraviolet/pull/6289) [`bee7198`](https://github.com/scaleway/ultraviolet/commit/bee7198ed7b5e078c1da18b523fc451dbd7b6d83) Thanks [@lisalupi](https://github.com/lisalupi)! - ## ⚠️⚠️ **This is the last release of this package** ⚠️⚠️

  - **This package will not be updated anymore**;
  - All of the components have been migrated to `@ultraviolet/ui` (as `compositions`). Up until `ultraviolet/ui v3.13.0`, both components in `ui/composition` and `plus` are _strictly the same_. More recent version of ui may diverge from plus;
  - All of Ultraviolet's documentation has been updated to remove references to `ultraviolet/plus`;
